...
class GroupSearchBaseMethod:
    ...
    def forward(self,qfs,tfs,idx_from_gfs,threshold=0.039,topk=1,para=0):
...
def local_crf_main(config):
    ...
    qfs2,tfs2,idx_from_gfs,args=LCTG.forward_trajectory(threshold=config['cluster_threshold'],seed=8,para=0)
    ...
    LCTG.rankscore(dist2,idx_from_gfs)
    for i in range(1,2):
